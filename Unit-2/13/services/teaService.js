  ...
  .service('teaService', ['$http', '$q', function($http, $q){
    ...
    var teaService = {
      getCategories: function(){
        return _teas.reduce(function(prev, tea){
          for (var category in tea.categories) {
            if (tea.categories.hasOwnProperty(category)) {
              var category = tea.categories[category]
              prev[category] = null;
            }
          }
          return prev;
